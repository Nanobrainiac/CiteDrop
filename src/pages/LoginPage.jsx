...
export default function LoginPage() {
  ...
  return (
    <section className="mx-auto grid max-w-6xl gap-8 px-4 py-16 sm:px-6 lg:grid-cols-[.9fr_1.1fr] lg:px-8">
      <div className="flex flex-col justify-center">
        <p className="text-sm font-bold uppercase text-acid">Admin access</p>
        <h1 className="mt-3 text-5xl font-black leading-none">Create and manage research pages.</h1>
